...
<head>
    ...
    <title>Admin Signup || E-commerce website</title>
...
<body>
    ...
    include "../assets/_db_connect.php";
        ...
        $sql = "INSERT INTO `admin_users` (`admin_username`, `admin_password`) VALUES ('$admin_username', '$admin_password');";
    ...
    <div class=" container">
        <div class="loginbox">
            ...
            <div class="content row">
                <p class="text-center col-12 fs-2"><strong>Welcome to E-commerce website || Signup to create your admin account   </strong></p>
                <div class="main-section col-12">
                <img src="../img/sweety_logo.png" class="text-center m-center" alt="" width="100px" style="border-radius: 10px;" srcset=""><br>
