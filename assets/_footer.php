  ...
  <div class="container-fluid footer-section text-start custom-text-respon">
      ...
      <div class=" row respon-row-custom desktop-footer">
          ...
          <div class="col-6 ">
              <div class="row respon-row-custom">
                  <div class="col-3 ">
                      <h5><a href="" class="custom-text-respon  text-light custom-footer-link">Main Menu</a></h5>
                      <h5><a href="" class="custom-text-respon text-light custom-footer-link">About</a></h5>
                      <h5><a href="" class="custom-text-respon text-light custom-footer-link">Shop</a></h5>
                      <h5><a href="" class="custom-text-respon text-light custom-footer-link">Help</a></h5>
                  </div>
                  <div class="col-3">
                      <h5><a href="" class="custom-text-respon text-light custom-footer-link">Our Company</a></h5>
                      <h5><a href="" class="custom-text-respon text-light custom-footer-link">Employee</a></h5>
                      <h5><a href="" class="custom-text-respon text-light custom-footer-link">Press</a></h5>
                  </div>
                  <div class="col-3">
                      <h5><a href="" class="custom-text-respon text-light custom-footer-link">Discover</a></h5>
                      <h5><a href="" class="custom-text-respon text-light custom-footer-link">The team</a></h5>
                      <h5><a href="" class="custom-text-respon text-light custom-footer-link">Our History</a></h5>
                      <h5><a href="" class="custom-text-respon text-light custom-footer-link">Brands</a></h5>
                  </div>
                  <div class="col-3 ">
                      <h5><a href="" class="custom-text-respon text-light custom-footer-link">Find Us On</a></h5>
                      <h5><a href="" class="custom-text-respon text-light custom-footer-link">Facebook</a></h5>
                      <h5><a href="" class="custom-text-respon text-light custom-footer-link">Twiter</a></h5>
                      <h5><a href="" class="custom-text-respon text-light custom-footer-link">Instragram</a></h5>
                  </div>
      ...
      <p class="text-respon developed-by "><small><br> <br>&copy; All rights are reserved by 2022 | <a href=""> Developed by Birat Deb. </a> | </small></p>
  </div>
